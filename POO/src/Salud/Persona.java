...
public class Persona {
    ...
    public void calcularImc(){
        ...
        if (pesoActual < 20) {
            ...
            System.out.println("El peso esta por debajo de lo ideal, su peso actual es "+pesoActual);
            
        } else if (pesoActual >= 20 && pesoActual <= 25) {

            System.out.println("El peso es ideal, su peso actual es "+pesoActual);

        } else if (pesoActual > 25){
        
            System.out.println("Tiene sobrepeso:c"+pesoActual);
        }
